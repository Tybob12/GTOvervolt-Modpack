...
export class $PoseStack implements $IForgePoseStack {
...
(arg0: $Supplier$Type<($ServicesKeySet$Type)>): $ServicesKeySet
}
...
export class $BufferBuilder extends $DefaultedVertexConsumer implements $BufferVertexConsumer {
 "format": $VertexFormat
 "defaultColorSet": boolean
...
export class $VertexFormat implements $VertexFormatAccessor {
...
(arg0: $App$Type<(Mu), (F)>): $Functor<(F), (Mu)>
}
...
(arg0: $TypeRewriteRule$Type): $TypeRewriteRule
}
