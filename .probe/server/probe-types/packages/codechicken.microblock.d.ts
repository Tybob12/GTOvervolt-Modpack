...
declare module "packages/codechicken/microblock/api/$SlottedHollowConnect" {
export {} // Mark the file as a module, do not remove unless there are other import/exports!
export interface $SlottedHollowConnect {

 "getHoleSize"(arg0: integer): integer

(arg0: integer): integer
}

export namespace $SlottedHollowConnect {
const probejs$$marker: never
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $SlottedHollowConnect$Type = ($SlottedHollowConnect);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $SlottedHollowConnect_ = $SlottedHollowConnect$Type;
}}
