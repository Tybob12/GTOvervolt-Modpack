...
import {$GTBedrockOreVeinEventJS, $GTBedrockOreVeinEventJS$Type} from "packages/com/gregtechceu/gtceu/integration/kjs/events/$GTBedrockOreVeinEventJS"
...
import {$GTFluidVeinEventJS, $GTFluidVeinEventJS$Type} from "packages/com/gregtechceu/gtceu/integration/kjs/events/$GTFluidVeinEventJS"
...
import {$GTOreVeinEventJS, $GTOreVeinEventJS$Type} from "packages/com/gregtechceu/gtceu/integration/kjs/events/$GTOreVeinEventJS"
...
export namespace GTCEuServerEvents {
function oreVeins(handler: (event: $GTOreVeinEventJS) => void): void
function fluidVeins(handler: (event: $GTFluidVeinEventJS) => void): void
function bedrockOreVeins(handler: (event: $GTBedrockOreVeinEventJS) => void): void
}
