...
(arg0: $NonNullUnaryOperator$Type<(T)>): $NonNullUnaryOperator<(T)>
}
...
import {$AbstractRegistrateAccessor, $AbstractRegistrateAccessor$Type} from "packages/com/gregtechceu/gtceu/core/mixins/$AbstractRegistrateAccessor"
...
export class $AbstractRegistrate<S extends $AbstractRegistrate<(S)>> implements $AbstractRegistrateAccessor {
...
declare module "packages/com/tterrag/registrate/$Registrate" {
import {$AbstractRegistrate, $AbstractRegistrate$Type} from "packages/com/tterrag/registrate/$AbstractRegistrate"

export class $Registrate extends $AbstractRegistrate<($Registrate)> {


public static "create"(arg0: string): $Registrate
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $Registrate$Type = ($Registrate);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $Registrate_ = $Registrate$Type;
}}
...
(arg0: $NonNullFunction$Type<(any), (any)>): $NonNullFunction<(T), (V)>
}
...
(arg0: $NonNullConsumer$Type<(any)>): $NonNullConsumer<(T)>
}
